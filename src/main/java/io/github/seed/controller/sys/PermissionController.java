...
public class PermissionController {
    ...
    @RecordLog(type = OperateType.CREATE, description = "新增权限", refModule = TableNameConst.SYS_PERMISSION, refIdEl = "#permission.id")
    ...
    @RecordLog(type = OperateType.UPDATE, description = "修改权限", refModule = TableNameConst.SYS_PERMISSION, refIdEl = "#permission.id")
    ...
    @RecordLog(type = OperateType.DELETE, description = "删除权限", refModule = TableNameConst.SYS_PERMISSION, refIdEl = "#id")
