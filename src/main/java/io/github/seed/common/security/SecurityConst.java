...
public interface SecurityConst {
     ...
     */
    String[] PERMIT_URLS = new String[]{"/favicon.ico", "/swagger-ui/**", "/v3/**", "/actuator", "/actuator/**",
            SecurityConst.LOGIN_URL, SecurityConst.LOGOUT_URL, SecurityConst.REFRESH_TOKEN_URL, "/test/**"};
}
