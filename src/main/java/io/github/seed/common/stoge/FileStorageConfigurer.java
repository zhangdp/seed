...
import io.github.seed.common.stoge.s3.S3StogeAdapter;
import io.github.seed.common.stoge.s3.S3Template;
import io.github.seed.common.stoge.local.LocalStogeAdapter;
...
public class FileStorageConfigurer implements InitializingBean {
    ...
    public S3Template s3Template() {
        ...
        S3Template template = new S3Template(s3Properties.getBucket(), s3Properties.getEndpoint(), s3Properties.getAccessKey(),
                s3Properties.getSecretKey(), s3Properties.getRegion(), s3Properties.isPathStyleAccessEnabled(), s3Properties.isChunkedEncodingEnabled());
