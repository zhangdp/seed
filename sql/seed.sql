...
(
    ...
    KEY ` sys_resource_permission_idx `
(
    `
    permission
    `
),
    KEY ` sys_resource_parent_id_idx `
(
    `
    parent_id
    `
...
(
    32
) NOT NULL COMMENT '角色标识',
    ` name ` varchar
(
    64
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色名称',
    ` description ` varchar
(
    255
) DEFAULT NULL COMMENT '描述',
...
-- ----------------------------
BEGIN;
INSERT INTO ` sys_role ` (` id `, ` code `, ` name `, ` description `, ` is_deleted `, ` created_date `, `
                          last_modified_date `)
...
(
    ...
    UNIQUE KEY ` sys_role_resource_uidx `
(
    `
    role_id
    `,
...
-- ----------------------------
BEGIN;
INSERT INTO ` sys_role_resource ` (` id `, ` role_id `, ` resource_id `, ` created_date `, ` last_modified_date `)
VALUES (1, 1, 1, '2023-04-12 18:14:20.054', NULL);
COMMIT;
...
(
    64
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '密码',
    ` mobile ` varchar
(
    16
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '手机号',
    ` gender ` char
(
    1
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '性别，F：女，M：男，null：未知',
...
(
    255
) DEFAULT NULL COMMENT '头像url地址',
    ` name ` varchar
(
    100
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '姓名',
    ` citizen_id ` varchar
(
    20
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '身份证号',
...
(
    ...
    UNIQUE KEY ` sys_user_username_idx `
(
    `
    username
    `
),
    KEY ` sys_user_mobile_idx `
(
    `
    mobile
    `
...
-- ----------------------------
BEGIN;
INSERT INTO ` sys_user ` (` id `, ` username `, ` password `, ` mobile `, ` gender `, ` birth_date `, ` email `, `
                          avatar_url `, ` name `, ` citizen_id `, ` dept_id `, ` created_date `, ` last_modified_date `,
                          ` is_deleted `, ` status `)
VALUES (1, 'admin', '$2a$10$wDjUgfO37shayK2QZoodL.EKj7mSyB/Mzn3G1tDif3C0kfr5bIQcC', '18900000000', 'F', '2000-01-01', 'admin@seed.com', NULL, '管理员', '123456789012345678', NULL, '2023-01-01 00:00:00.000', '2024-06-27 10:29:27.447', 0, 0);
INSERT INTO ` sys_user ` (` id `, ` username `, ` password `, ` mobile `, ` gender `, ` birth_date `, ` email `, `
                          avatar_url `, ` name `, ` citizen_id `, ` dept_id `, ` created_date `, ` last_modified_date `,
                          ` is_deleted `, ` status `)
VALUES (2, 'test', '$2a$10$wDjUgfO37shayK2QZoodL.EKj7mSyB/Mzn3G1tDif3C0kfr5bIQcC', '13900000000', 'M', '2000-01-01', 'test@seed.com', NULL, '测试员', NULL, NULL, '2023-04-12 10:17:18.000', '2024-06-27 10:29:27.462', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO ` sys_user_role ` (` id `, ` user_id `, ` role_id `, ` created_date `, ` last_modified_date `)
VALUES (1, 1, 1, '2023-04-12 16:31:55.492', NULL);
COMMIT;
